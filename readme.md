...
1. [Create a Godwoken account on testnet](src/challenges/1.create.godwoken.account.md)
...
4. [Issue a layer 1 sUDT token, then deposit it into polyjuice](src/challenges/4.issue.sudt.deposit.md)
