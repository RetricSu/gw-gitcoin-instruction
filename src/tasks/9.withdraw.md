...
node ./packages/tools/lib/account-cli.js withdraw -r <INSERT_TESTNET_RPC_URL> -p <YOUR_LAYER1_PRIVATE_KEY> -o <YOUR_LAYER1_ADDRESS> -c <SHANNONS_AMOUNT>
```
...
```sh
cd godwoken-examples
node ./packages/tools/lib/account-cli.js withdraw -c 40000000000 -p 0x79682c20bbcaf7fcf18eb0c69b133c872227ceb88971090e7f2242c80cd54d18 -o ckt1qyq9u5vzgtklnqrr6cevra7w2utrsxmjgefs72sfju -r http://3.235.223.161:18114
```

> Note: The private key you pass to `withdraw` command needs to be exactly the same as the one you passed when doing `deposit`.
