...
We will take this block of code and copy it into `app.tsx` in the following location. First, locate the existing Web3 instance, which should match the line below.

```js
const web3 = new Web3((window as any).ethereum);
```

Delete this line, and replace is with the Polyjuice version that we just created a moment ago. Now our application is setup to communicate with Polyjuice using Web3!
