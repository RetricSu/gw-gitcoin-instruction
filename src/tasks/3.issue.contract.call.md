...
The example smart contract from the previous task is `SimpleStorage.sol`, and the corresponding ABI is found in `2-deploy-contract/build/contracts/SimpleStorage.json` after the contract is compiled. Below is the contents of the this file.
