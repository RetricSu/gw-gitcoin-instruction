...
### 1. Setup MetaMask Account on the Rinkeby Testnet

Install MetaMask, create account and use [Rinkeby Authenticated Faucet](https://faucet.rinkeby.io/) or the [Rinkeby Ether Faucet](http://rinkeby-faucet.com/) to get funds.
...
If you want to check your Layer 2 token balance now to confirm that you've received the SUDT you can deploy SUDT-ERC20 proxy contract with SUDT ID: `142` (ckETH) and then check the balance. [You can find instructions how to do so in the previous task.](./5.deploy.erc20.proxy.contract.md) We encourage you to do it because then you'll be able to confirm the asset has safely arrived in your account!
