...
Nervos' solutions to cross-chain interoperability are major steps towards these goals. At the base of this is Force Bridge, the decentralized cross-chain bridge which enables the transfer of assets between Nervos and other blockchains. Force Bridge is currently in the late testing phase, and supports moving tokens to and from the Ethereum Rinkeby testnet. The Cardano bridge has also been announced and is in the late stages of development. More networks will continue to be added, continuously growing the network for the foreseeable future.
...
<img src="../images/metamask-select-network.png" alt="" style="border: 1px solid #eeeeee; height: 400px;" />
...
Open the example code from [`gw-gitcoin-instruction/src/examples/6-bridge/index.js`](../examples/6-bridge/index.js) in an editor of your choosing.
...
Open the [Force Bridge Testnet](https://force-bridge-dev.ckbapp.dev/bridge/Ethereum/Nervos?xchain-asset=0x0000000000000000000000000000000000000000) in a web browser. Make sure you have Rinkeby network selected in MetaMask, and that your selected account has Rinkeby ETH.
...
<img src="../images/metamask-send-bridge-transfer.png" height="400" style="border: 1px solid #eeeeee" />
...
<img src="../images/bridge-tx-sent.png" width="300" />
...
<img src="../images/bridge-1-lock-eth.png" height="300" />
...
<img src="../images/force-bridge-lock-eth-confirmed.png" height="300" />
...
<img src="../images/force-bridge-success.png" height="300" />
...
If you would like to check your Layer 2 token balance, you can repeat the steps from the [previous task](./5.deploy.erc20.proxy.contract.md). This is not a requirement for task submission, but you are encouraged to do so to verify that the tokens have arrived safely in your account.
