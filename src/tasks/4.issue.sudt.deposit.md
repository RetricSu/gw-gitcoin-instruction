...
A tutorial on how to use the `sudt-cli` tool can be found [here](../component-tutorials/2.issue.sudt.cli.md).

### 3. [Setup the Godwoken Examples Tools Package](../component-tutorials/3.setup.and.use.account.cli.md)
