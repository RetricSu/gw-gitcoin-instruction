...
You can follow the instructions in [this tutorial](https://github.com/Kuzirashi/gw-gitcoin-instruction/tree/master/src/component-tutorials/3.setup.and.use.account.cli.md) to setup the Godwoken Examples tool pack.
