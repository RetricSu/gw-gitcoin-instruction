...
In this step you will need to clone the Gitcoin Task Instructions examples repository, which contains the example code required by the steps in this task. The code we will be working with in this step will compile your smart contract and deploy it. This uses the original versions of Web3.js and Truffle for Ethereum, with only a small difference in that they use a custom Web3.js provider.
...
Execute following commands to clone the Git repository and install the dependencies for the task:
