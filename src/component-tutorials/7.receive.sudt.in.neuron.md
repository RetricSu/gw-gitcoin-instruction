...
On Nervos you can hold both Nervos native currency - CKB, but also all kinds of tokens. In this tutorial you will learn how to receive SUDT in Neuron wallet. Before proceeding further make sure you:
1. have at least 142 CKB + transaction fee
2. have Token ID, Name, Symbol, and Number of Decimals prepared
