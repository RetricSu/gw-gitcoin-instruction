...
Windows (PowerShell):
```ps
.\ckb-cli.exe account export --lock-arg <YOUR_LOCK_ARG> --extended-privkey-path C:\Users\<YOUR_USERNAME>\projects\privkey.txt
```
...
Using this command (Linux/MacOS):
